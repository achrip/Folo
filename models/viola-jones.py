...
fullbody_model = cv.CascadeClassifier(cv.data.haarcascades +
                             "haarcascade_fullbody.xml")
upperbody_model = cv.CascadeClassifier(cv.data.haarcascades +
...
for filename in os.listdir(POSITIVE_DIR):
    if filename.endswith(".png"): 
        ...
        detections = upperbody_model.detectMultiScale(grayscale, 1.1, 5)
